...
#>    [1 / 34] Running logistic model...
#>    [2 / 34] Running randomForest_classification model...
#>    [3 / 34] Running tm_bag_mars_classification model...
#>    [4 / 34] Running tm_bag_tree_C50_classification model...
#>    [5 / 34] Running tm_bag_tree_rpart_classification model...
#>    [6 / 34] Running tm_bart_classification model...
#>    [7 / 34] Running tm_boost_tree_C50_classification model...
#>    [8 / 34] Running tm_boost_tree_xgboost_classification model...
#>    [9 / 34] Running tm_decision_tree_rpart_classification model...
#>    [10 / 34] Running tm_discrim_flexible_classification model...
#>    [11 / 34] Running tm_discrim_linear_MASS_classification model...
#>    [12 / 34] Running tm_discrim_linear_mda_classification model...
#>    [13 / 34] Running tm_discrim_linear_sda_classification model...
#>    [14 / 34] Running tm_discrim_linear_sparsediscrim_classification model...
#>    [15 / 34] Running tm_discrim_regularized_classification model...
#>    [16 / 34] Running tm_gen_additive_mod_mgcv_classification model...
#>    [17 / 34] Running tm_logistic_glm_classification model...
#>    [18 / 34] Running tm_logistic_glmnet_classification model...
#>    [19 / 34] Running tm_logistic_LiblineaR_classification model...
#>    [20 / 34] Running tm_logistic_stan_classification model...
#>    [21 / 34] Running tm_naive_bayes model...
#>    [22 / 34] Running weka_bagging_classification model...
#>    [23 / 34] Running weka_decisionstump_classification model...
#>    [24 / 34] Running weka_ibk_classification model...
#>    [25 / 34] Running weka_J48_classification model...
#>    [26 / 34] Running weka_lmt_classification model...
#>    [27 / 34] Running weka_logistic_classification model...
#>    [28 / 34] Running weka_logitboost_classification model...
#>    [29 / 34] Running weka_oner_classification model...
#>    [30 / 34] Running weka_part_classification model...
#>    [31 / 34] Running weka_smo_classification model...
#>    [32 / 34] Running weka_stacking_classification model...
#>    [33 / 34] Running weka_adaboostm1_classification model...
#>    [34 / 34] Running weka_jrip_classification model...
```
