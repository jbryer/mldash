...
There are `r nrow(ml_datasets)` included in the `mldash` package. You can view the packages in the [`datasets` vignette](https://jbryer.github.io/mldash/articles/datasets.html).
...
There are `r nrow(ml_models)` included in the `mldash` package. You can view the models in the [`models` vignette](https://jbryer.github.io/mldash/articles/models.html).
